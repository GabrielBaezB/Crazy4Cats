...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference("Reaction.count") do
      post reactions_url, params: { reaction: { post_id: @reaction.post_id, reaction_type: @reaction.reaction_type, user_id: @reaction.user_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { post_id: @reaction.post_id, reaction_type: @reaction.reaction_type, user_id: @reaction.user_id } }
